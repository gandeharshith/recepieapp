...
//                                     fontSize: 17,
//                                     color: 'black'
//                                 }}>Looking for your favourite meal</Text>
//                              <TouchableOpacity
//         style={{
//           position: 'absolute',
//           top: 20,
...
//         <MaterialCommunityIcons name="heart" size={24} color="red" style={{ marginRight: 5 }} />
//         <Text style={{ color: 'black', fontWeight: 'bold' }}>Favorites</Text>
//       </TouchableOpacity>
//                         </View>
...
//                         <View>
//                             <Text style={{ paddingHorizontal: 20, fontSize: 24, color: "black", fontWeight: '500' }}>Trending</Text>
//                             <FlatList
//                                 showsVerticalScrollIndicator={false}
//                                 showsHorizontalScrollIndicator={false}
//                                 contentContainerStyle={{ paddingHorizontal: 18, paddingVertical: 20 }}
...
class HomeScreen extends React.Component {
  ...
  onPress={() => this.props.navigation.navigate('RecipesListScreen', { filter: true })}>
  ...
  <Text style={{ color: 'black', fontWeight: 'bold' }}>Filter</Text>
            ...
            <View
              ...
              <TouchableNativeFeedback
                ...
                onPress={() => {
                  if (searchKeyword == '') return;
                  this.props.navigation.navigate('Resipes', {
              ...
              <FlatList
                ...
                renderItem={({ item }) => (
                  <TouchableNativeFeedback
                    ...
                    useForeground={true}
                    onPress={() =>
                      this.props.navigation.navigate('Resipes', { category: item })
                    }>
                    <View
                      style={{
                        overflow: 'hidden',
            ...
            <View>
              <Text style={{ paddingHorizontal: 20, fontSize: 24, color: 'black', fontWeight: '500' }}>
                Trending
              </Text>
              <FlatList
                showsVerticalScrollIndicator={false}
                  ...
                  <TouchableNativeFeedback
                    ...
                    <View
                      ...
                      <View
                        ...
                        <Text numberOfLines={1} ellipsizeMode="tail" style={{ color: 'white', paddingHorizontal: 20, paddingVertical: 5 }}>
                          {item.strMeal}
                        </Text>
                      </View>
                    </View>
                ...
                renderItem={({ item }) => (
                  <TouchableNativeFeedback
                    ...
                    <View
                      ...
                      <View style={{ flex: 1, padding: 16 }}>
                        <Text numberOfLines={2} ellipsizeMode="tail" style={{ fontSize: 21, fontWeight: 'bold', color: 'black' }}>
                          {item.strMeal}
                        </Text>
                        <Text numberOfLines={3} ellipsizeMode="tail">{item.strInstructions}</Text>
                      </View>
